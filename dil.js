...
window.dialogue_datsocool=function(player,items){
    ...
    return ["Hi! I'm 1cool_pig, the creator of this game!","In this questline, I'll reward some Star Eggs for every quest!","I'll also reward you with a Star Treat at the last quest!","So here's the first quest:",function(){player.addQuest('Programs',[['redPollen',30000000],['pollenFromRoseField',10000000],['pollenFromStrawberryField',10000000],['pollenFromMushroomField',10000000],['flames',30],['strawberryTokens',25],['strawberry',50],['redExtractTokens',2],['redExtract',3],['timesUsingTheRedCannon',25],['redAbilityTokens',250],['scorpion',15],['werewolf',3]],'1cool_pig');},"Great! Here's your Star Egg!","Hatch it to get a gifted bee you don't have in your hive!",function(){addReward([['honey',75000000],['starEgg',1],['redExtract',3],['ticket',5],['treat',1000],['royalJelly',25],['invigoratingVial',1]])},"Here's your next quest, good luck!",function(){player.addQuest('Locations',[['pollen',75000000],['goo',10000000],['pollenFromPumpkinPatch',15000000],['pollenFromCactusField',15000000],['pollenFromCloverField',10000000],['pollenFromSunflowerField',7500000],['royalJellyTokens',5],['boostTokens',500],['tokensFromPlanters',30],['rhinoBeetle',15],['ladybug',15]],'1cool_pig');},"Good!",function(){addReward([['honey',100000000],['starEgg',1],['fieldDice',5],['glitter',3],['treat',2500],['ticket',5],['royalJelly',50]])},"Here's the next quest!",function(){player.addQuest('Buffers',[['whitePollen',100000000],['pollenFromPineapplePatch',30000000],['pollenFromDandelionField',10000000],['pollenFromSunflowerField',10000000],['bombTokens',500],['markTokens',250],['tokensFromSprouts',50],['sunflowerSeedTokens',25],['pineappleTokens',25],['timesUsingTheSlingshot',25],['spider',5]],'1cool_pig');},"Impressive!",function(){addReward([['honey',100000000],['starEgg',1],['enzymes',5],['oil',5],['jellyBeans',10],['glue',10]])},"Just 2 more quests to go!",function(){player.addQuest('Pointers',[['pollenFromAntField',10000000],['ant',500],['armyAnt',50],['fireAnt',50],['flyingAnt',50],['giantAnt',10],['tunnelBear',1],['kingBeetle',2],['rogueViciousBee',3],['werewolf',5],['spider',10],['mantis',20],['scorpion',20],['battleTokens',500]],'1cool_pig');},"Great! Your next quest will be harder, so good luck!",function(){addReward([['honey',250000000],['starEgg',1],['stinger',10],['purplePotion',1],['loadedDice',1],['treat',3500]])},"This is the last quest, complete it for a star treat!",function(){player.addQuest('Draw Call',[['pollen',1000000000],['bluePollen',750000000],['bubbles',150],['blueAbilityTokens',1000],['hasteTokens',500],['tokensFromSprouts',100],['timesUsingTheBlueCannon',40],['tropicalDrink',3],['fallingCoconuts',35],['mantis',15],['rhinoBeetle',30],['rogueViciousBee',3]],'1cool_pig');},"Epic! You're the best beekeeper I've ever met! You deserve this Star Treat!",function(){addReward([['honey',2500000000],['starTreat',1],['blueExtract',5],['royalJelly',250],['ticket',15],['treat',5270],['blueberry',2],['magicBean',10]])},"You did it!","All my quests are done and you've earned your star treat!","sad that i only fit 8 references into my NPC's short questlines :(","ok bye","..." ,"Hold on." ,"You're STILL here?" ,"Most players would've quit by now.", ,"Alright then... let's see how far you can go.", ,"Welcome to the ASCENDED DEVELOPER questline.", function(){player.addQuest('Infinite Loop',[['pollen',20000000000],['redPollen',8000000000],['bluePollen',8000000000],['whitePollen',8000000000],['abilityTokens',4000],['boostTokens',2000]],'1cool_pig');}, "Looks like your hive escaped the infinite loop!", function(){addReward([['honey',40000000000],['starEgg',1],['royalJelly',1500],['ticket',150],['treat',30000]])}, ,"Time to stress-test the hive.", function(){player.addQuest('Server Stress Test',[['pollenFromPepperPatch',200000000],['pollenFromCoconutField',200000000],['fallingCoconuts',150],['flames',200],['rogueViciousBee',10],['tunnelBear',3]],'1cool_pig');}, "Servers survived somehow...", function(){addReward([['honey',60000000000],['starEgg',1],['purplePotion',4],['glitter',10],['magicBean',25]])}, ,"Your bees are starting to break the balance of the game...", function(){player.addQuest('Balance Breaker',[['pollen',40000000000],['bombTokens',3000],['markTokens',2000],['tokensFromSprouts',400],['mantis',60],['werewolf',20]],'1cool_pig');}, "...yeah you definitely broke the balance.", function(){addReward([['honey',90000000000],['mythicEgg',1],['royalJelly',2000],['ticket',200],['treat',50000]])}, ,"Okay this next one is ridiculous.", function(){player.addQuest('Developer Madness',[['pollen',75000000000],['redPollen',30000000000],['bluePollen',30000000000],['whitePollen',30000000000],['tokensFromSprouts',500],['flames',300],['bubbles',300],['rogueViciousBee',15]],'1cool_pig');}, "I honestly didn't expect anyone to finish that.", function(){addReward([['honey',150000000000],['starEgg',2],['starJelly',1],['ticket',300],['treat',75000]])}, ,"..." ,"This is the FINAL quest.", ,"The one I made as a joke because I thought nobody would ever finish it.", function(){player.addQuest('God of the Hive',[['pollen',150000000000],['redPollen',50000000000],['bluePollen',50000000000],['whitePollen',50000000000],['tokensFromSprouts',750],['flames',500],['bubbles',500],['mantis',100],['werewolf',40],['rogueViciousBee',20]],'1cool_pig');}, ,"..." ,"YOU DID IT???", ,"WHAT???", function(){addReward([ ['honey',500000000000], ['mythicEgg',3], ['starTreat',2], ['royalJelly',5000], ['ticket',500], ['treat',150000], ['glitter',25], ['purplePotion',10] ])}, ,"Alright." ,"I'm done making quests.", ,"You've officially beaten everything.", ,"You are now...", ,"THE GOD OF THE HIVE.", ,"Seriously go outside now."]
}
